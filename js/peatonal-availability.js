...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object.values(units).forEach(function (unit) {
    ...
    const label = unit.status === 'occupied' ? (en ? 'OCCUPIED · SPOTONE OFFICE' : 'OCUPADO · OFICINA SPOTONE') : (en ? 'RENTED' : 'ALQUILADO');
    card.dataset.alq = '1';
